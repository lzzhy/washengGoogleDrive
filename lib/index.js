...
export var searchFile = function (words) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    gapi.client.drive.files
                        .list({
                        corpora: "user",
                        q: "name contains '".concat(words, "' and (mimeType = 'application/pdf' or mimeType = 'image/png' or mimeType = 'image/jpeg' or mimeType = 'image/webp' or mimeType = 'image/gif' or mimeType = 'application/vnd.google-apps.folder' or mimeType = 'application/vnd.google-apps.document' or mimeType = 'application/vnd.google-apps.drawing' or mimeType = 'application/vnd.google-apps.presentation' or mimeType = 'application/vnd.google-apps.spreadsheet' or mimeType = 'application/vnd.google-apps.jam') and trashed = false"),
...
var googleDrive = /** @class */ (function () {
    ...
    googleDrive.searchFiles = function (words) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                if (!gapiInited || !gisInited) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, searchFile(words)];
                                    case 1:
                                        data = (_a.sent()).data;
                                        resolve(data);
                                        return [2 /*return*/];
